...
```yaml $(multiapi) && $(track2)
clear-output-folder: true
package-top-folder: storage_preview
batch:
  - tag: package-2019-06
  - tag: package-2019-04
  - tag: package-2018-11
...
``` yaml $(multiapiscript)
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2019_06_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2019_04_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2018_11_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2018_07_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2018_03_01_preview
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2018_02_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2017_10_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2017_06_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2016_12_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2016_01_01
```
...
output-folder: $(python-sdks-folder)/$(package-top-folder)/azure-mgmt-storage/azure/mgmt/storage/v2015_06_15
```
